;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)',' MIRINGIN HP NYAAA', 'COBA LIAT MING', 'KATA INI', 'KAYAKNYA ADA YANG ANEH','AKU GA BOONG KOK', 'PENCET LAGI', 'AKU TAU KAMU PASTI KESEL', 'TAPI INI BENER ADA YANG ANEH', 'AKU JANJI','AYO SEMANGAT','I LOVE', 'YOU ♡', 'MAAFIN AKU YA MING CANTIK','KALO AKU BIKIN KAMU KESEL TIAP HARI', 'HEHE'];
  ...
  function particleText(imgData) {
    ...
    var pxls = [];
    for (var w = CANVASWIDTH; w > 0; w -= 2) {  // Sedikit lebih lebar jaraknya untuk kestabilan
  ...
  class Particle {
    constructor(canvas) {
      ...
      this.delta = 0.1;  // Mengurangi kecepatan agar teks terbentuk lebih jelas
      ...
      this.opacity = 0;
      this.fadeInRate = 0.02;  // Menyesuaikan kecepatan fade in untuk stabilitas
      this.fadeOutRate = 0.05;  // Menyesuaikan kecepatan fade out
